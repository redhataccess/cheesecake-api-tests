...
class test_module_content:
  ...
  def edit_metadata(self, api_auth, setup_test_products):
      ...
      print(utilities.add_metadata(fixture.url, self.path_for_module, self.variant, api_auth, setup_test_products))
      print(utilities.publish_content(fixture.url,self.path_for_module, self.variant, api_auth))
      ...
      check_that("The abstract of the module", data_from_published_module.json()["module"]["description"],
                 is_not_none())
      #products test is pending
      #search keywords test is pending
      ...
      print("Check url frag to path::", path)
      print("The module url fragment", data_from_published_module.json()["module"]["module_url_fragment"])
      check_that("The module url fragment", data_from_published_module.json()["module"]["module_url_fragment"], equal_to(path))
      check_that("The view_uri", data_from_published_module.json()["module"]["view_uri"], equal_to(fixture.cp_url + module_uuid))
      check_that("The revision_id", data_from_published_module.json()["module"]["revision_id"], equal_to("released"))
      check_that("The product name", data_from_published_module.json()["module"]["products"]["product_name"], equal_to(constants.product_name))
      check_that("The product version", data_from_published_module.json()["module"]["products"]["product_version"], equal_to(constants.product_version))
